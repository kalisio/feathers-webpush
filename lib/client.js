...
export async function checkPrerequisites () {
  ...
  if (!('PushManager' in window)) return new BadRequest('Push isn\'t supported on this browser')
  // Check notification support
  if (!('Notification' in window)) return new BadRequest('This browser does not support notifications')
  // Check notification permissions
  if (window.Notification.permission === 'denied') return new DeniedPermissionNotifications('Denied permission to send notifications')
  return true
}
