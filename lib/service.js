...
export class Service {
  ...
  async create (data, params) {
    ...
    debug(`method 'create' called with 'dataNotification': ${data.dataNotification}, 'subscriptionService': ${data.subscriptionService} and 'subscriptionFilter': ${data.subscriptionFilter}`)
    ...
    _.forEach(subscriptionsService, subscriptionService => {
      ...
      if (_.has(subscriptionService, 'subscription')) subscriptions.push(subscriptionService.subscription)
    })
