...
export async function requestNotificationPermission () {
  ...
  if (window.Notification.permission === 'denied') throw new PermissionDeniedNotifications('Denied permission to send notifications')
...
export async function subscribePushNotifications (publicVapidKey) {
  ...
  // Convert the subscription key of an ArrayBuffer into a character string
